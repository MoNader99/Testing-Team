...
describe('SignUpTest', function(){
    ...
    it('should press on SignUp button and get the new page title', async () => {
    ...
    it('should test the case of entering an invalid email', async () => {        
    ...
    it('should test the case of entering an email which is already token', async () => {       
            ...
            /////test 3: Not entered
    it('should test the case of not entering an email', async () => {
            await driver.findElement(By.xpath(require("../AppSelectors").SignUpEmail)).clear();
            await driver.findElement(By.xpath(require("../AppSelectors").SignUpPassword)).click();///clicking anywhere for the msg to appear
            await driver.sleep(3000);
            Checkstring = await driver.findElement(By.xpath(require("../AppSelectors").SignUpInvalidEmailmsg)).getText(); //finding the msg place and copying its text
    ...
    it('should test the case of entering a confirm email which does not match the entered one', async () => {       
    ...
    it('should test the case of entering an Invalid confirm email', async () => {
            ...
            //test 3: Not entered 
    it('should test the case of  not entering an confirm email', async () => {        
            await driver.findElement(By.xpath(require("../AppSelectors").SignUpConfirmEmail)).clear();
            await driver.findElement(By.xpath(require("../AppSelectors").SignUpPassword)).click();///clicking anywhere for the msg to appear
            await driver.sleep(3000);
            Checkstring = await driver.findElement(By.xpath(require("../AppSelectors").SignUpInvalidConfirmEmailmsg)).getText();
    ...
    it('should test the case of entering a very short password', async () => { 
            ...
            /////test 2: Not entered
    it('should test the case of not entering a password', async () => { 
    ...
    it('should test the case of entering a very long Displayname', async () => {         
            ...
            /////test 2: Not entered
    it('should test the case of not entering a Displayname', async () => {          
    ...
    it('should test the case of entering an invalid Day of birth (less than 1)', async () => {         
    ...
    it('should test the case of entering an invalid Day of birth (more than 31)', async () => {
    ...
    it('should test the case of entering an invalid Day of birth (more than 2 digits)', async () => {
            await driver.findElement(By.xpath(require("../AppSelectors").SignUpDayOfBirth)).clear();
    ...
    it('should test the case of entering an invalid Day of birth (negative number)', async () => {       
            await driver.findElement(By.xpath(require("../AppSelectors").SignUpDayOfBirth)).clear();
    ...
    it('should test the case of not entering a Day of birth', async () => {        
            await driver.findElement(By.xpath(require("../AppSelectors").SignUpDayOfBirth)).clear();
            await driver.findElement(By.xpath(require("../AppSelectors").SignUpConfirmEmail)).click();///clicking anywhere for the msg to appear
            await driver.sleep(3000);
            Checkstring = await driver.findElement(By.xpath(require("../AppSelectors").SignUpInvalidDayOfBirthmsg)).getText();
        ...
        ///////Month of birth test cases testing
            /////test 1: Not entered
    it('should test the case of not entering a Month of birth', async () => {         
            await driver.findElement(By.xpath(require("../AppSelectors").SignUpSubmitButton)).click();///msg won't appear untill we press the submit button
            await driver.sleep(6000);
    ...
    it('should test the case of entering an invalid Year of birth (less than 1900)', async () => {        
    ...
    it('should test the case of entering an invalid Year of birth (more than 1999)', async () => {  
    ...
    it('should test the case of entering an invalid Year of birth (more than 4 digits)', async () => {          
            await driver.findElement(By.xpath(require("../AppSelectors").SignUpyearOfBirth)).clear();
            ...
            /////test 4: Invalid entering negative number
    it('should test the case of entering an invalid Year of birth (negative number)', async () => {         
            await driver.findElement(By.xpath(require("../AppSelectors").SignUpyearOfBirth)).clear();
            ...
            /////test 5: Invalid not entered
    it('should test the case of not entering a Year of birth', async () => { 
            await driver.findElement(By.xpath(require("../AppSelectors").SignUpyearOfBirth)).clear();
            await driver.findElement(By.xpath(require("../AppSelectors").SignUpConfirmEmail)).click();///clicking anywhere for the msg to appear
            await driver.sleep(3000);
            Checkstring = await driver.findElement(By.xpath(require("../AppSelectors").SignUpInvalidyearOfBirthmsg)).getText();
        ...
        ///////Female-male test cases testing
            /////test 1: Not entered
    it('should test the case of not choosing a gender', async () => {        
            await driver.findElement(By.xpath(require("../AppSelectors").SignUpSubmitButton)).click();///msg won't appear untill we press the submit button
            await driver.sleep(6000);
    ...
    it('should test a Successful case', async () => {
